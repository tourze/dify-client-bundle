# 获取应用 WebApp 设置 (Workflow)

## OpenAPI

````yaml zh-hans/openapi_workflow.json get /site
paths:
  path: /site
  method: get
  servers:
      ...
      application/json:
        schemaArray:
          - type: object
            ...
            description: Workflow 应用 WebApp 设置。
            refIdentifier: '#/components/schemas/WorkflowWebAppSettingsResponseCn'
        examples:
          example:
            value:
              title: <string>
